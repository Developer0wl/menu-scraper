...
const OFFICIAL_URL = 'https://www.hardees.com/menu/nutritional_info';
const ALT_URL = 'https://www.hardees.com/nutrition';
...
const KNOWN_ITEMS = [
  { name: 'Frisco Thickburger',            category: 'Burgers' },
  { name: 'Monster Thickburger',           category: 'Burgers' },
  { name: '1/3 lb. Thickburger',           category: 'Burgers' },
  ...
  { name: 'Made From Scratch Biscuit',     category: 'Breakfast' },
  { name: 'Sausage & Egg Biscuit',         category: 'Breakfast' },
  { name: 'Bacon, Egg & Cheese Biscuit',   category: 'Breakfast' },
  { name: 'Country Ham & Egg Biscuit',     category: 'Breakfast' },
...
class Hardees extends BaseScraper {
  constructor() { super({ chainName: 'Hardees', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async extractAllergens(item) {
    ...
    row.sourceText='Allergen data not accessible — check hardees.com/menu/nutritional_info';
    return row;
  }
}
module.exports = Hardees;
