...
const OFFICIAL_URL = 'https://www.bjsrestaurants.com/menu/nutrition';
const ALT_URL = 'https://www.bjsrestaurants.com/menu';
...
const KNOWN_ITEMS = [
  { name: 'BJs Burger', category: 'Burgers' },
  { name: 'Pepperoni Pizza', category: 'Pizza' },
  { name: 'Classic Combo Pizza', category: 'Pizza' },
  { name: 'Chicken & Bacon Ranch Pizza', category: 'Pizza' },
  { name: 'Enlightened Wildfire Salmon', category: 'Entrees' },
  { name: 'Grilled Salmon', category: 'Entrees' },
  { name: 'Chicken Marsala', category: 'Entrees' },
  { name: 'Honey Glazed Salmon', category: 'Entrees' },
  { name: 'Oven Roasted Chicken', category: 'Entrees' },
  { name: 'BBQ Chicken Sandwich', category: 'Sandwiches' },
  { name: 'Club Sandwich', category: 'Sandwiches' },
  { name: 'Avocado Egg Rolls', category: 'Appetizers' },
  { name: 'Spinach & Artichoke Dip', category: 'Appetizers' },
  { name: 'Loaded Potato Skins', category: 'Appetizers' },
  { name: 'Pizookie', category: 'Desserts' },
  { name: 'Chocolate Chip Pizookie', category: 'Desserts' },
  { name: 'Mini Pizookies', category: 'Desserts' },
  { name: 'Handcrafted Root Beer Float', category: 'Drinks' },
];
class BJsRestaurants extends BaseScraper {
  constructor() { super({ chainName: 'BJsRestaurants', officialUrl: OFFICIAL_URL }); this._headers = null; }
