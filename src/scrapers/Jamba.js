...
const OFFICIAL_URL = 'https://www.jamba.com/nutrition';
const ALT_URL = 'https://www.jamba.com/menu';
...
const KNOWN_ITEMS = [
  { name: 'Mango-a-go-go Smoothie', category: 'Smoothies' },
  { name: 'Strawberries Wild Smoothie', category: 'Smoothies' },
  { name: 'Tropical Greens Smoothie', category: 'Smoothies' },
  { name: 'Berry Fulfilling Smoothie', category: 'Smoothies' },
  { name: 'Orange Dream Machine Smoothie', category: 'Smoothies' },
  { name: 'Peanut Butter Mood Smoothie', category: 'Smoothies' },
  { name: 'Caribbean Passion Smoothie', category: 'Smoothies' },
  { name: 'Razzmatazz Smoothie', category: 'Smoothies' },
  { name: 'Acai Primo Bowl', category: 'Bowls' },
  { name: 'Peanut Butter Banana Bowl', category: 'Bowls' },
  { name: 'Coconut Berry Bowl', category: 'Bowls' },
  { name: 'Chunky Strawberry Bowl', category: 'Bowls' },
  { name: 'Orange Juice', category: 'Juices' },
  { name: 'Celery Juice', category: 'Juices' },
  { name: 'Steel Cut Oatmeal', category: 'Food' },
  { name: 'Bountiful Breakfast Bowl', category: 'Food' },
  { name: 'Spinach & Egg White Wrap', category: 'Food' },
];
class Jamba extends BaseScraper {
  constructor() { super({ chainName: 'Jamba', officialUrl: OFFICIAL_URL }); this._headers = null; }
