...
const OFFICIAL_URL = 'https://www.steaknshake.com/nutrition';
const ALT_URL = 'https://www.steaknshake.com/menu';
...
const KNOWN_ITEMS = [
  { name: 'The Original Double',           category: 'Steakburgers' },
  { name: 'Triple Steakburger',            category: 'Steakburgers' },
  { name: 'Bacon Cheeseburger',            category: 'Steakburgers' },
  { name: 'Frisco Melt',                   category: 'Steakburgers' },
  { name: 'Mushroom & Swiss',              category: 'Steakburgers' },
  { name: 'Chili Mac',                     category: 'Steakburgers' },
  { name: 'Royale with Cheese',            category: 'Steakburgers' },
  { name: 'The Classic Steakburger',       category: 'Steakburgers' },
  { name: 'Chicken Sandwich',              category: 'Chicken' },
  { name: 'Grilled Chicken Sandwich',      category: 'Chicken' },
  { name: 'Chili 5-Way',                   category: 'Chili' },
  { name: 'Chili 3-Way',                   category: 'Chili' },
  { name: 'Chili Mac',                     category: 'Chili' },
  ...
  { name: 'Oreo Cookie Shake',             category: 'Shakes' },
  { name: 'Banana Shake',                  category: 'Shakes' },
];

class SteakNShake extends BaseScraper {
  constructor() { super({ chainName: 'SteakNShake', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async _parseTable() {
    const data = await this.page.evaluate(() => {
      ...
      const items = []; let cat = 'Steakburgers';
  ...
  async _parseBodyText() {
    ...
    const items = []; let cat = 'Steakburgers'; const seen = new Set();
  ...
  async extractAllergens(item) {
    ...
    row.sourceText='Allergen data not accessible — check steaknshake.com/nutrition';
    return row;
  }
}
