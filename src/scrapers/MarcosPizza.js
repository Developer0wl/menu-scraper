...
const OFFICIAL_URL = 'https://www.marcos.com/nutrition';
const ALT_URL = 'https://www.marcos.com/menu';
...
const KNOWN_ITEMS = [
  { name: 'Pepperoni Magnifico', category: 'Pizza' },
  { name: 'All Meat Alto', category: 'Pizza' },
  { name: 'White Cheezy', category: 'Pizza' },
  { name: 'Garden Pizza', category: 'Pizza' },
  { name: 'Chicken Fresco', category: 'Pizza' },
  { name: 'Hawaiian Chicken', category: 'Pizza' },
  { name: 'Sausage Supremo', category: 'Pizza' },
  { name: 'Build Your Own Pizza (Large)', category: 'Pizza' },
  { name: 'Italian Chef Sub', category: 'Subs' },
  { name: 'Ham & Cheese Sub', category: 'Subs' },
  { name: 'Meatball Sub', category: 'Subs' },
  { name: 'Chicken Sub', category: 'Subs' },
  { name: 'Deluxe Wings', category: 'Wings' },
  { name: 'Boneless Wings', category: 'Wings' },
  { name: 'Chicken Dippers', category: 'Sides' },
  { name: 'Cinnamon Squares', category: 'Sides' },
  { name: 'Breadsticks', category: 'Sides' },
  { name: 'House Salad', category: 'Salads' },
  { name: 'Caesar Salad', category: 'Salads' },
];
class MarcosPizza extends BaseScraper {
  constructor() { super({ chainName: 'MarcosPizza', officialUrl: OFFICIAL_URL }); this._headers = null; }
