...
const OFFICIAL_URL = 'https://www.outback.com/nutrition';
const ALT_URL = 'https://www.outback.com/menu';
...
const KNOWN_ITEMS = [
  ...
  {
    "name": "Wood-Fire Grilled Chicken",
    "category": "Chicken"
  },
  {
...
class OutbackSteakhouse extends BaseScraper {
  constructor() { super({ chainName: 'OutbackSteakhouse', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async extractAllergens(item) {
    ...
    row.sourceText='Allergen data not accessible -- check https://www.outback.com/nutrition';
    return row;
  }
}
module.exports = OutbackSteakhouse;
