...
const OFFICIAL_URL = 'https://www.olivegarden.com/nutrition-info';
const ALT_URL = 'https://www.olivegarden.com/menu';
...
class OliveGarden extends BaseScraper {
  constructor() { super({ chainName: 'OliveGarden', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async _parseBodyText() {
    ...
    const items = []; let cat = 'Pasta'; const seen = new Set();
  ...
  async extractAllergens(item) {
    ...
    row.sourceText='Allergen data not accessible -- check https://www.olivegarden.com/nutrition-info';
    return row;
  }
}
module.exports = OliveGarden;
