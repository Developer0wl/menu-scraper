...
const OFFICIAL_URL = 'https://www.crackerbarrel.com/menu/nutrition';
const ALT_URL = 'https://www.crackerbarrel.com/menu';
const COLUMN_MAP = {
...
const KNOWN_ITEMS = [
  { name: 'Old Timer Breakfast',            category: 'Breakfast' },
  { name: 'Grandpas Country Fried Breakfast', category: 'Breakfast' },
  { name: 'Sunrise Sampler',                category: 'Breakfast' },
  { name: 'Uncle Haralds French Toast',     category: 'Breakfast' },
  { name: 'Buttermilk Pancakes',            category: 'Breakfast' },
  { name: 'Mommas Pancake Breakfast',       category: 'Breakfast' },
  { name: 'Eggs in a Basket',               category: 'Breakfast' },
  { name: 'Biscuits and Gravy',             category: 'Breakfast' },
  { name: 'Country Boy Breakfast',          category: 'Breakfast' },
  { name: 'Chicken n Dumplins',             category: 'Dinner Plates' },
  { name: 'Country Fried Chicken',          category: 'Dinner Plates' },
  { name: 'Country Fried Steak',            category: 'Dinner Plates' },
  { name: 'Grilled Chicken Tenderloin',     category: 'Dinner Plates' },
  { name: 'Meatloaf',                       category: 'Dinner Plates' },
  { name: 'Roast Beef',                     category: 'Dinner Plates' },
  { name: 'Beef Stew',                      category: 'Dinner Plates' },
  { name: 'Baby Back Ribs',                 category: 'Dinner Plates' },
  { name: 'Coleslaw',                       category: 'Sides' },
  { name: 'Turnip Greens',                  category: 'Sides' },
  { name: 'Fried Apples',                   category: 'Sides' },
  { name: 'Macaroni and Cheese',            category: 'Sides' },
  { name: 'Biscuit',                        category: 'Sides' },
  { name: 'Cornbread Muffin',               category: 'Sides' },
  { name: 'Hash Brown Casserole',           category: 'Sides' },
  { name: 'Double Chocolate Fudge Coca-Cola Cake', category: 'Desserts' },
  { name: 'Apple Streusel French Toast',    category: 'Desserts' },
  { name: 'Cinnamon Roll French Toast',     category: 'Desserts' },
];

class CrackerBarrel extends BaseScraper {
  constructor() { super({ chainName: 'CrackerBarrel', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async extractAllergens(item) {
    ...
    row.sourceText='Allergen data not accessible — check crackerbarrel.com/menu/nutrition';
    return row;
  }
}
module.exports = CrackerBarrel;
