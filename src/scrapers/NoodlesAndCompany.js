...
const OFFICIAL_URL = 'https://www.noodles.com/allergen-information';
...
const KNOWN_ITEMS = [
  ...
  { name: 'Japanese Pan Noodles', category: 'Noodles' },
  { name: 'Bangkok Curry', category: 'Noodles' },
  { name: 'Pasta Fresca', category: 'Noodles' },
  { name: 'Pesto Cavatappi', category: 'Noodles' },
  { name: 'Buttered Noodles', category: 'Noodles' },
  { name: 'Mushroom Stroganoff', category: 'Noodles' },
  { name: 'Beef Stroganoff', category: 'Noodles' },
  { name: 'Zoodles (Zucchini)', category: 'Noodles' },
  { name: 'Indonesian Peanut Saute', category: 'Noodles' },
  { name: 'The Orchard Harvest Salad', category: 'Salads' },
  { name: 'Med Salad', category: 'Salads' },
  { name: 'Caesar Salad', category: 'Salads' },
  { name: 'Crispy Rice Bowl', category: 'Bowls' },
  { name: 'Grilled Chicken', category: 'Proteins' },
  { name: 'Braised Beef', category: 'Proteins' },
  { name: 'Shrimp', category: 'Proteins' },
  { name: 'Bread Baguette', category: 'Sides' },
];
class NoodlesAndCompany extends BaseScraper {
  constructor() { super({ chainName: 'NoodlesAndCompany', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async _parseBodyText() {
    ...
    const items = []; let cat = 'Noodles'; const seen = new Set();
