...
const OFFICIAL_URL = 'https://www.jackinthebox.com/food-allergens';
const ALT_URL = 'https://www.jackinthebox.com/food/nutrition';
...
class JackInTheBox extends BaseScraper {
  constructor() { super({ chainName: 'JackInTheBox', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async extractAllergens(item) {
    ...
    row.sourceText='Allergen data not accessible -- check https://www.jackinthebox.com/food-allergens';
    return row;
  }
}
module.exports = JackInTheBox;
