...
const OFFICIAL_URL = 'https://www.bojangles.com/our-food/nutritional-information';
const ALT_URL = 'https://www.bojangles.com/our-food';
...
const KNOWN_ITEMS = [
  { name: 'Cajun Filet Biscuit', category: 'Biscuit Sandwiches' },
  { name: 'Sausage Egg & Cheese Biscuit', category: 'Biscuit Sandwiches' },
  { name: 'Country Ham Biscuit', category: 'Biscuit Sandwiches' },
  { name: 'Bacon Egg & Cheese Biscuit', category: 'Biscuit Sandwiches' },
  { name: 'Steak Biscuit', category: 'Biscuit Sandwiches' },
  { name: 'Bo-Berry Biscuit', category: 'Biscuit Sandwiches' },
  { name: 'Chicken Supremes (4 piece)', category: 'Chicken' },
  { name: 'Cajun Fried Chicken Leg', category: 'Chicken' },
  { name: 'Cajun Fried Chicken Thigh', category: 'Chicken' },
  { name: 'Cajun Fried Chicken Breast', category: 'Chicken' },
  { name: 'Cajun Fried Chicken Wing', category: 'Chicken' },
  { name: 'Grilled Chicken Sandwich', category: 'Sandwiches' },
  { name: 'Dirty Rice', category: 'Sides' },
  { name: 'Cajun Pintos', category: 'Sides' },
  { name: 'Coleslaw', category: 'Sides' },
  { name: 'Macaroni & Cheese', category: 'Sides' },
  { name: 'Mashed Potatoes & Gravy', category: 'Sides' },
...
class Bojangles extends BaseScraper {
  constructor() { super({ chainName: 'Bojangles', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async _parseTable() {
    const data = await this.page.evaluate(() => {
      ...
      const items = []; let cat = 'Biscuit Sandwiches';
  ...
  async _parseBodyText() {
    ...
    const items = []; let cat = 'Biscuit Sandwiches'; const seen = new Set();
