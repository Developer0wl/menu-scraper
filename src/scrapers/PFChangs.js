...
const OFFICIAL_URL = 'https://www.pfchangs.com/nutrition';
const ALT_URL = 'https://www.pfchangs.com/menu';
...
const KNOWN_ITEMS = [
  { name: 'Changs Chicken Lettuce Wraps', category: 'Appetizers' },
  { name: 'Crab Wontons', category: 'Appetizers' },
  { name: 'Wok-Seared Edamame', category: 'Appetizers' },
  { name: 'Egg Rolls', category: 'Appetizers' },
  { name: 'Kung Pao Chicken', category: 'Entrees' },
  { name: 'Mongolian Beef', category: 'Entrees' },
  { name: 'Changs Spicy Chicken', category: 'Entrees' },
  { name: 'Sweet & Sour Chicken', category: 'Entrees' },
  { name: 'Honey Chicken', category: 'Entrees' },
  { name: 'Sesame Chicken', category: 'Entrees' },
  { name: 'Mapo Tofu', category: 'Entrees' },
  { name: 'Beef & Broccoli', category: 'Entrees' },
  { name: 'Shrimp Lo Mein', category: 'Noodles' },
  { name: 'Changs Lo Mein', category: 'Noodles' },
  { name: 'Dan Dan Noodles', category: 'Noodles' },
  { name: 'Fried Rice', category: 'Rice' },
  { name: 'Brown Rice', category: 'Rice' },
  { name: 'Shanghai Cucumber Salad', category: 'Salads' },
  { name: 'Chocolate Dome Cake', category: 'Desserts' },
  { name: 'The Original Great Wall of Chocolate', category: 'Desserts' },
];
class PFChangs extends BaseScraper {
  constructor() { super({ chainName: 'PFChangs', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async _parseBodyText() {
    ...
    const items = []; let cat = 'Entrees'; const seen = new Set();
