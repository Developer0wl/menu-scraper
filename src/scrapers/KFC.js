...
const OFFICIAL_URL = 'https://www.kfc.com/nutrition/allergens';
const ALT_URL = 'https://www.kfc.com/nutrition';
...
const KNOWN_ITEMS = [
  ...
  {
    "name": "Original Recipe Chicken (Wing)",
    "category": "Chicken Pieces"
  },
  {
  ...
  {
    "name": "Extra Crispy Chicken (Thigh)",
    "category": "Chicken Pieces"
  },
  {
    "name": "Spicy Crispy Chicken (Breast)",
    "category": "Chicken Pieces"
  },
  {
...
class KFC extends BaseScraper {
  constructor() { super({ chainName: 'KFC', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async extractAllergens(item) {
    ...
    row.sourceText='Allergen data not accessible -- check https://www.kfc.com/nutrition/allergens';
    return row;
  }
}
module.exports = KFC;
