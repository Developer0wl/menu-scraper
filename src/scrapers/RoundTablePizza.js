...
const OFFICIAL_URL = 'https://www.roundtablepizza.com/nutritional-information';
const ALT_URL = 'https://www.roundtablepizza.com/menu';
...
const KNOWN_ITEMS = [
  { name: 'Chicken & Garlic Gourmet', category: 'Pizza' },
  { name: 'King Arthur Supreme', category: 'Pizza' },
  { name: 'Guinevere Garden Delight', category: 'Pizza' },
  { name: 'Maui Zaui', category: 'Pizza' },
  { name: 'Smokehouse Combo', category: 'Pizza' },
  { name: 'Classic Pepperoni', category: 'Pizza' },
  { name: 'Cheese Pizza', category: 'Pizza' },
  { name: 'Bacon & Tomato Pizza', category: 'Pizza' },
  { name: 'Traditional Wings (6 piece)', category: 'Wings' },
  { name: 'Traditional Wings (12 piece)', category: 'Wings' },
  { name: 'Boneless Wings (6 piece)', category: 'Wings' },
...
class RoundTablePizza extends BaseScraper {
  constructor() { super({ chainName: 'RoundTablePizza', officialUrl: OFFICIAL_URL }); this._headers = null; }
