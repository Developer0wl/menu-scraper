...
const OFFICIAL_URL = 'https://www.moes.com/nutrition';
const ALT_URL = 'https://www.moes.com/menu';
...
const KNOWN_ITEMS = [
  { name: 'The Homewrecker Burrito', category: 'Burritos' },
  { name: 'Joey Bag of Donuts Burrito', category: 'Burritos' },
  { name: 'Funk Meister Burrito', category: 'Burritos' },
  { name: 'Billy Barou Bowl', category: 'Bowls' },
  { name: 'Earmuffs Bowl', category: 'Bowls' },
  { name: 'Art Vandalay Taco', category: 'Tacos' },
  { name: 'Solid Gold Quesadilla', category: 'Quesadillas' },
  { name: 'Chicken Stack', category: 'Stacks' },
  { name: 'Club Quesadilla', category: 'Quesadillas' },
  { name: 'The Ugly Naked Guy', category: 'Salads' },
  { name: 'Overachiever Salad', category: 'Salads' },
  { name: 'Crunchy Taco', category: 'Tacos' },
  { name: 'Soft Taco', category: 'Tacos' },
  { name: 'Nachos', category: 'Sides' },
  { name: 'Chips & Salsa', category: 'Sides' },
  { name: 'Guacamole', category: 'Sides' },
  { name: 'Kids Meal Burrito', category: 'Kids' },
  { name: 'Kids Meal Quesadilla', category: 'Kids' },
];
class MoesSouthwestGrill extends BaseScraper {
  constructor() { super({ chainName: 'MoesSouthwestGrill', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async _parseBodyText() {
    ...
    const items = []; let cat = 'Burritos'; const seen = new Set();
