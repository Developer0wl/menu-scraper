...
const OFFICIAL_URL = 'https://www.chilis.com/menu/nutrition/allergen';
const ALT_URL = 'https://www.chilis.com/menu/nutrition';
...
class Chilis extends BaseScraper {
  constructor() { super({ chainName: 'Chilis', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async extractAllergens(item) {
    ...
    row.sourceText='Allergen data not accessible -- check https://www.chilis.com/menu/nutrition/allergen';
    return row;
  }
}
module.exports = Chilis;
