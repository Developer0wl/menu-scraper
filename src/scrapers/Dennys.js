...
const OFFICIAL_URL = 'https://www.dennys.com/food/nutrition';
const ALT_URL = 'https://www.dennys.com/food/';
...
const KNOWN_ITEMS = [
  ...
  {
    "name": "Bacon Eggs & Hash Browns",
    "category": "Breakfast"
  },
  {
    "name": "Omelette (Build Your Own)",
    "category": "Breakfast"
  },
  {
    "name": "Fit Slam",
...
class Dennys extends BaseScraper {
  constructor() { super({ chainName: 'Dennys', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async extractAllergens(item) {
    ...
    row.sourceText='Allergen data not accessible -- check https://www.dennys.com/food/nutrition';
    return row;
  }
}
module.exports = Dennys;
