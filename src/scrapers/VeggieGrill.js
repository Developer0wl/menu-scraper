...
const OFFICIAL_URL = 'https://www.veggiegrill.com/menu';
const ALT_URL = 'https://www.veggiegrill.com/nutrition';
...
const KNOWN_ITEMS = [
  { name: 'Quinoa Crunch Burger', category: 'Burgers' },
  { name: 'VG Beyond Burger', category: 'Burgers' },
  { name: 'Santa Fe Crispy Chickin Sandwich', category: 'Sandwiches' },
  { name: 'VG Chickin Sandwich', category: 'Sandwiches' },
  { name: 'Blackened Chickin Sandwich', category: 'Sandwiches' },
  { name: 'Harvest Bowl', category: 'Bowls' },
  { name: 'Protein Greens', category: 'Bowls' },
  { name: 'Chipotle Crunch Salad', category: 'Salads' },
  { name: 'Kale Caesar', category: 'Salads' },
  { name: 'Grilled Corn Tacos', category: 'Tacos' },
  { name: 'Crispy Chickin Tacos', category: 'Tacos' },
  { name: 'VG Chili', category: 'Starters' },
  { name: 'Crispy Cauliflower', category: 'Starters' },
  { name: 'Sweet Potato Fries', category: 'Sides' },
  { name: 'Seasonal Vegetables', category: 'Sides' },
];
class VeggieGrill extends BaseScraper {
  constructor() { super({ chainName: 'VeggieGrill', officialUrl: OFFICIAL_URL }); this._headers = null; }
