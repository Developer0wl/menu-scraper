...
const OFFICIAL_URL = 'https://www.ihop.com/en/menu/nutrition-allergens';
const ALT_URL = 'https://www.ihop.com/en/menu/';
...
const KNOWN_ITEMS = [
  ...
  {
    "name": "Harvest Grain & Nut Pancakes",
    "category": "Pancakes"
  },
  {
...
class IHOP extends BaseScraper {
  constructor() { super({ chainName: 'IHOP', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async _parseBodyText() {
    ...
    const items = []; let cat = 'Pancakes'; const seen = new Set();
  ...
  async extractAllergens(item) {
    ...
    row.sourceText='Allergen data not accessible -- check https://www.ihop.com/en/menu/nutrition-allergens';
    return row;
  }
}
module.exports = IHOP;
