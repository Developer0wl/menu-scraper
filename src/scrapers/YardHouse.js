...
const OFFICIAL_URL = 'https://www.yardhouse.com/nutrition';
const ALT_URL = 'https://www.yardhouse.com/menu';
...
const KNOWN_ITEMS = [
  { name: 'Half Yard Nachos', category: 'Appetizers' },
  ...
  { name: 'Grilled Chicken Tacos', category: 'Tacos' },
  { name: 'Carne Asada Tacos', category: 'Tacos' },
  { name: 'Impossible Burger', category: 'Burgers' },
  { name: 'Classic Cheeseburger', category: 'Burgers' },
  { name: 'Bacon Cheddar Burger', category: 'Burgers' },
  { name: 'BBQ Ranch Burger', category: 'Burgers' },
  { name: 'Grilled Salmon', category: 'Entrees' },
  { name: 'Chicken Tenders', category: 'Entrees' },
  { name: 'Steak & Eggs', category: 'Brunch' },
  { name: 'French Toast', category: 'Brunch' },
  { name: 'Caesar Salad', category: 'Salads' },
  { name: 'House Salad', category: 'Salads' },
  { name: 'Garlic Noodles', category: 'Sides' },
  { name: 'Truffle Fries', category: 'Sides' },
];
class YardHouse extends BaseScraper {
  constructor() { super({ chainName: 'YardHouse', officialUrl: OFFICIAL_URL }); this._headers = null; }
