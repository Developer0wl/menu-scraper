...
const OFFICIAL_URL = 'https://www.goldencorral.com/eat/nutrition';
const ALT_URL = 'https://www.goldencorral.com/nutrition';
...
const KNOWN_ITEMS = [
  { name: 'Pot Roast', category: 'Carved Meats' },
  { name: 'Rotisserie Chicken', category: 'Carved Meats' },
  { name: 'Bourbon Street Chicken', category: 'Entrees' },
  { name: 'Fried Chicken', category: 'Entrees' },
  { name: 'Baked Chicken', category: 'Entrees' },
  { name: 'Meatloaf', category: 'Entrees' },
  { name: 'Beef Tips', category: 'Entrees' },
  { name: 'Sirloin Steak', category: 'Entrees' },
  ...
  { name: 'Bread Rolls', category: 'Bread' },
  { name: 'Cornbread', category: 'Bread' },
  { name: 'Yeast Rolls', category: 'Bread' },
  { name: 'Banana Pudding', category: 'Desserts' },
  { name: 'Chocolate Cake', category: 'Desserts' },
  { name: 'Soft Serve Ice Cream', category: 'Desserts' },
];
class GoldenCorral extends BaseScraper {
  constructor() { super({ chainName: 'GoldenCorral', officialUrl: OFFICIAL_URL }); this._headers = null; }
