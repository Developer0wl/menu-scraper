...
const OFFICIAL_URL = 'https://www.papajohns.com/us/en/food/pizza/allergen-information.html';
const ALT_URL = 'https://www.papajohns.com/us/en/food/pizza/';
...
const KNOWN_ITEMS = [
  {
    "name": "Original Crust Cheese Pizza",
    "category": "Pizza"
  },
  {
    "name": "Original Crust Pepperoni Pizza",
    "category": "Pizza"
  },
  {
    "name": "Original Crust Sausage Pizza",
    "category": "Pizza"
  },
  {
  ...
  {
    "name": "Garlic Parmesan Crust Pizza",
    "category": "Pizza"
  },
  {
    "name": "Papadias (Philly Cheesesteak)",
    "category": "Papadias"
  },
  {
    "name": "Papadias (Italian Meats)",
    "category": "Papadias"
  },
  {
    "name": "Breadsticks",
...
class PapaJohns extends BaseScraper {
  constructor() { super({ chainName: 'PapaJohns', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async extractAllergens(item) {
    ...
    row.sourceText='Allergen data not accessible -- check https://www.papajohns.com/us/en/food/pizza/allergen-information.html';
    return row;
  }
}
module.exports = PapaJohns;
