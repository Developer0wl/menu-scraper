...
const OFFICIAL_URL = 'https://www.longhornsteakhouse.com/full-menu/nutrition';
const ALT_URL = 'https://www.longhornsteakhouse.com/full-menu';
...
const KNOWN_ITEMS = [
  { name: 'Flo\'s Filet',                  category: 'Steaks' },
  { name: 'Outlaw Ribeye',                  category: 'Steaks' },
  { name: 'LongHorn Porterhouse',           category: 'Steaks' },
  { name: 'T-Bone',                         category: 'Steaks' },
  { name: 'Renegade Sirloin',               category: 'Steaks' },
  { name: 'Wild West Shrimp',               category: 'Steaks' },
  { name: 'Redrock Grilled Shrimp',         category: 'Steaks' },
  { name: 'Grilled Chicken',                category: 'Chicken & Seafood' },
  { name: 'Parmesan Crusted Chicken',       category: 'Chicken & Seafood' },
  { name: 'Crispy Chicken Tender Dinner',   category: 'Chicken & Seafood' },
  { name: 'Salmon',                         category: 'Chicken & Seafood' },
  { name: 'Shrimp & Lobster Dip',           category: 'Appetizers' },
  { name: 'Crispy Brussel Sprouts',         category: 'Appetizers' },
  ...
  { name: 'LongHorn Salad',                 category: 'Salads' },
  { name: 'Grilled Chicken Salad',          category: 'Salads' },
  { name: 'Baked Potato',                   category: 'Sides' },
  { name: 'Loaded Baked Potato',            category: 'Sides' },
  { name: 'Rice Pilaf',                     category: 'Sides' },
  { name: 'Fresh Seasonal Vegetables',      category: 'Sides' },
  { name: 'Mac & Cheese',                   category: 'Sides' },
  { name: 'Molten Lava Cake',               category: 'Desserts' },
  { name: 'Chocolate Stampede',             category: 'Desserts' },
  { name: 'Strawberry Shortcake',           category: 'Desserts' },
];

class LongHornSteakhouse extends BaseScraper {
  constructor() { super({ chainName: 'LongHornSteakhouse', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async _parseBodyText() {
    ...
    const items = []; let cat = 'Steaks'; const seen = new Set();
  ...
  async extractAllergens(item) {
    ...
    row.sourceText='Allergen data not accessible — check longhornsteakhouse.com';
    return row;
  }
}
