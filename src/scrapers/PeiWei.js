...
const OFFICIAL_URL = 'https://www.peiwei.com/nutrition';
const ALT_URL = 'https://www.peiwei.com/menu';
...
const KNOWN_ITEMS = [
  { name: 'Honey Seared Chicken', category: 'Entrees' },
  { name: 'Kung Pao Chicken', category: 'Entrees' },
  { name: 'Mongolian Beef', category: 'Entrees' },
  { name: 'Changs Chicken', category: 'Entrees' },
  { name: 'Sweet & Sour Chicken', category: 'Entrees' },
  { name: 'Thai Dynamite Shrimp', category: 'Entrees' },
  { name: 'Pad Thai (Chicken)', category: 'Noodles' },
  { name: 'Dan Dan Noodles', category: 'Noodles' },
  { name: 'Lo Mein (Chicken)', category: 'Noodles' },
  { name: 'Fried Rice (Chicken)', category: 'Rice' },
  { name: 'Fried Rice (Tofu)', category: 'Rice' },
  { name: 'Vietnamese Chicken Salad Rolls', category: 'Appetizers' },
  { name: 'Edamame', category: 'Appetizers' },
  { name: 'Egg Rolls', category: 'Appetizers' },
  { name: 'Wei Better Orange Chicken', category: 'Entrees' },
  { name: 'Tofu & Broccoli', category: 'Entrees' },
  { name: 'Chicken Lettuce Wraps', category: 'Appetizers' },
];
class PeiWei extends BaseScraper {
  constructor() { super({ chainName: 'PeiWei', officialUrl: OFFICIAL_URL }); this._headers = null; }
