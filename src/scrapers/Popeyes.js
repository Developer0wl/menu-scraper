...
const OFFICIAL_URL = 'https://www.popeyes.com/nutrition/allergens';
const ALT_URL = 'https://www.popeyes.com/menu';
...
const KNOWN_ITEMS = [
  ...
  {
    "name": "Handcrafted Tenders (3 pc)",
    "category": "Chicken"
  },
  {
    "name": "Handcrafted Tenders (5 pc)",
    "category": "Chicken"
  },
  {
    "name": "Chicken (2 pc Leg & Thigh)",
    "category": "Chicken"
  },
  {
    "name": "Chicken (2 pc Breast & Wing)",
    "category": "Chicken"
  },
  {
    "name": "Spicy Chicken (2 pc)",
    "category": "Chicken"
  },
  {
...
class Popeyes extends BaseScraper {
  constructor() { super({ chainName: 'Popeyes', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async _parseBodyText() {
    ...
    const items = []; let cat = 'Chicken'; const seen = new Set();
  ...
  async extractAllergens(item) {
    ...
    row.sourceText='Allergen data not accessible -- check https://www.popeyes.com/nutrition/allergens';
    return row;
  }
}
