...
const OFFICIAL_URL = 'https://www.zaxbys.com/nutrition';
const ALT_URL = 'https://www.zaxbys.com/menu';
...
const KNOWN_ITEMS = [
  { name: 'Zaxbys Chicken Fingers (5 piece)', category: 'Chicken Fingers' },
  { name: 'Zaxbys Chicken Fingers (10 piece)', category: 'Chicken Fingers' },
  { name: 'Wings & Things',               category: 'Wings' },
  { name: 'Traditional Wings (5 piece)',  category: 'Wings' },
  { name: 'Traditional Wings (10 piece)', category: 'Wings' },
  { name: 'Boneless Wings (5 piece)',     category: 'Wings' },
  { name: 'Boneless Wings (10 piece)',    category: 'Wings' },
  { name: 'Zaxbys Sandwich',             category: 'Sandwiches' },
  { name: 'Spicy Zax Sandwich',          category: 'Sandwiches' },
  { name: 'Grilled Chicken Sandwich',    category: 'Sandwiches' },
  { name: 'Club Sandwich',               category: 'Sandwiches' },
  { name: 'Zaxby Salad',                 category: 'Salads' },
  { name: 'Grilled Chicken Salad',       category: 'Salads' },
  { name: 'Caesar Salad',                category: 'Salads' },
  { name: 'Crinkle Fries',               category: 'Sides' },
  { name: 'Texas Toast',                 category: 'Sides' },
  { name: 'Celery',                      category: 'Sides' },
  { name: 'Coleslaw',                    category: 'Sides' },
];
class Zaxbys extends BaseScraper {
  constructor() { super({ chainName: 'Zaxbys', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async _parseTable() {
    const data = await this.page.evaluate(() => {
      ...
      const items = []; let cat = 'Chicken Fingers';
  ...
  async _parseBodyText() {
    ...
    const items = []; let cat = 'Chicken Fingers'; const seen = new Set();
  ...
  async extractAllergens(item) {
    ...
    row.sourceText='Allergen data not accessible — check zaxbys.com/nutrition';
    return row;
  }
}
