...
const OFFICIAL_URL = 'https://arbys.com/nutrition/allergen-information';
const ALT_URL = 'https://arbys.com/full-menu';
...
const KNOWN_ITEMS = [
  ...
  {
    "name": "Jamocha Shake (Regular)",
    "category": "Shakes"
  }
];

class Arbys extends BaseScraper {
  constructor() { super({ chainName: 'Arbys', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async _parseTable() {
    const data = await this.page.evaluate(() => {
      ...
      const items = []; let cat = 'Sandwiches';
  ...
  async _parseBodyText() {
    ...
    const items = []; let cat = 'Sandwiches'; const seen = new Set();
  ...
  async extractAllergens(item) {
    ...
    row.sourceText='Allergen data not accessible -- check https://arbys.com/nutrition/allergen-information';
    return row;
  }
}
module.exports = Arbys;
