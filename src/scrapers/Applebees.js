...
const OFFICIAL_URL = 'https://www.applebees.com/en/menu/nutrition-and-allergens';
const ALT_URL = 'https://www.applebees.com/en/menu';
...
class Applebees extends BaseScraper {
  constructor() { super({ chainName: 'Applebees', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async extractAllergens(item) {
    ...
    row.sourceText='Allergen data not accessible -- check https://www.applebees.com/en/menu/nutrition-and-allergens';
    return row;
  }
}
module.exports = Applebees;
