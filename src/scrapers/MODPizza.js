...
const ALT_URL = 'https://modpizza.com/menu';
...
const KNOWN_ITEMS = [
  { name: 'MOD Pizza (11-inch)', category: 'Pizza' },
  { name: 'Calexico', category: 'Pizza' },
  { name: 'Lucy Sunshine', category: 'Pizza' },
  { name: 'Dillon James', category: 'Pizza' },
  { name: 'Dominic', category: 'Pizza' },
  { name: 'Maddy', category: 'Pizza' },
  { name: 'Miles', category: 'Pizza' },
  { name: 'Tristan', category: 'Pizza' },
  { name: 'No. 9', category: 'Pizza' },
  { name: 'Jasper', category: 'Pizza' },
  { name: 'Vinnie Van', category: 'Pizza' },
  { name: 'Original Salad', category: 'Salads' },
  { name: 'Caesar Salad', category: 'Salads' },
  { name: 'Original Crust (Gluten-Free)', category: 'Crust' },
  { name: 'Cauliflower Crust', category: 'Crust' },
];
class MODPizza extends BaseScraper {
  constructor() { super({ chainName: 'MODPizza', officialUrl: OFFICIAL_URL }); this._headers = null; }
