...
const OFFICIAL_URL = 'https://www.sonicdrivein.com/menu/nutrition';
const ALT_URL = 'https://www.sonicdrivein.com/menu';
...
const KNOWN_ITEMS = [
  ...
  {
    "name": "Double SONIC Cheeseburger",
    "category": "Burgers"
  },
  {
...
class Sonic extends BaseScraper {
  constructor() { super({ chainName: 'Sonic', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async extractAllergens(item) {
    ...
    row.sourceText='Allergen data not accessible -- check https://www.sonicdrivein.com/menu/nutrition';
    return row;
  }
}
