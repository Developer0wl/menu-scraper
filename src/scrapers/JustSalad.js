...
const OFFICIAL_URL = 'https://www.justsalad.com/nutrition';
const ALT_URL = 'https://www.justsalad.com/menu';
...
const KNOWN_ITEMS = [
  { name: 'Classic Cobb', category: 'Salads' },
  { name: 'Kale Caesar', category: 'Salads' },
  { name: 'Sweet & Spicy', category: 'Salads' },
  { name: 'Spicy Falafel', category: 'Salads' },
  { name: 'Bangkok Salad', category: 'Salads' },
  { name: 'Protein Avocado Bowl', category: 'Bowls' },
  { name: 'Classic Caesar Bowl', category: 'Bowls' },
  { name: 'Harvest Bowl', category: 'Bowls' },
  { name: 'Crispy Chicken Wrap', category: 'Wraps' },
  { name: 'Grilled Chicken Wrap', category: 'Wraps' },
  { name: 'Turkey & Avocado Wrap', category: 'Wraps' },
...
class JustSalad extends BaseScraper {
  constructor() { super({ chainName: 'JustSalad', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async _parseBodyText() {
    ...
    const items = []; let cat = 'Salads'; const seen = new Set();
