...
const OFFICIAL_URL = 'https://www.carlsjr.com/menu/nutritional_info';
const ALT_URL = 'https://www.carlsjr.com/nutrition';
...
const KNOWN_ITEMS = [
  { name: 'Famous Star with Cheese',       category: 'Burgers' },
  { name: 'Super Star with Cheese',        category: 'Burgers' },
  { name: 'Double Famous Star',            category: 'Burgers' },
  { name: 'Western Bacon Cheeseburger',    category: 'Burgers' },
  { name: 'Jalapeño Thickburger',          category: 'Burgers' },
  { name: 'Mushroom & Swiss Burger',       category: 'Burgers' },
  { name: 'Big Carl',                      category: 'Burgers' },
  { name: 'Charbroiled Chicken Sandwich',  category: 'Chicken' },
  { name: 'Spicy Chicken Sandwich',        category: 'Chicken' },
  { name: 'Hand-Breaded Chicken Tenders',  category: 'Chicken' },
  { name: 'Chicken Stars',                 category: 'Chicken' },
  { name: 'Egg & Cheese Biscuit',          category: 'Breakfast' },
  { name: 'Bacon, Egg & Cheese Biscuit',   category: 'Breakfast' },
  { name: 'Sausage, Egg & Cheese Biscuit', category: 'Breakfast' },
  { name: 'Loaded Breakfast Burrito',      category: 'Breakfast' },
  { name: 'French Fries (Small)',          category: 'Sides' },
  { name: 'Onion Rings',                   category: 'Sides' },
  { name: 'Zucchini (6 piece)',            category: 'Sides' },
...
class CarlsJr extends BaseScraper {
  constructor() { super({ chainName: 'CarlsJr', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async _parseBodyText() {
    ...
    const items = []; let cat = 'Burgers'; const seen = new Set();
  ...
  async extractAllergens(item) {
    ...
    row.sourceText='Allergen data not accessible — check carlsjr.com/menu/nutritional_info';
    return row;
  }
}
