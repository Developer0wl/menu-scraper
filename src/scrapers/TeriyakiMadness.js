...
const OFFICIAL_URL = 'https://www.teriyakimadness.com/nutrition';
const ALT_URL = 'https://www.teriyakimadness.com/menu';
...
const KNOWN_ITEMS = [
  { name: 'Chicken Bowl', category: 'Bowls' },
  { name: 'Steak Bowl', category: 'Bowls' },
  { name: 'Tofu Bowl', category: 'Bowls' },
  { name: 'Salmon Bowl', category: 'Bowls' },
  { name: 'Shrimp Bowl', category: 'Bowls' },
  { name: 'Mix Bowl (Chicken + Steak)', category: 'Bowls' },
  { name: 'Brown Rice', category: 'Bases' },
  { name: 'White Rice', category: 'Bases' },
  { name: 'Noodles', category: 'Bases' },
  { name: 'Salad Greens', category: 'Bases' },
  { name: 'Teriyaki Chicken', category: 'Proteins' },
  { name: 'Teriyaki Steak', category: 'Proteins' },
  { name: 'Yakisoba Noodles', category: 'Specialties' },
  { name: 'Spicy Chicken Bowl', category: 'Bowls' },
  { name: 'Gyoza (6 piece)', category: 'Sides' },
  { name: 'Edamame', category: 'Sides' },
  { name: 'Egg Rolls', category: 'Sides' },
];
class TeriyakiMadness extends BaseScraper {
  constructor() { super({ chainName: 'TeriyakiMadness', officialUrl: OFFICIAL_URL }); this._headers = null; }
