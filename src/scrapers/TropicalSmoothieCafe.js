...
const OFFICIAL_URL = 'https://www.tropicalsmoothiecafe.com/nutrition';
const ALT_URL = 'https://www.tropicalsmoothiecafe.com/menu';
...
const KNOWN_ITEMS = [
  { name: 'Jetty Punch Smoothie', category: 'Smoothies' },
  { name: 'Bahama Mama Smoothie', category: 'Smoothies' },
  { name: 'Sunrise Sunset Smoothie', category: 'Smoothies' },
  { name: 'Watermelon Wave Smoothie', category: 'Smoothies' },
  { name: 'Mocha Madness Smoothie', category: 'Smoothies' },
  { name: 'Detox Island Green Smoothie', category: 'Smoothies' },
  { name: 'Beach Bum Smoothie', category: 'Smoothies' },
  { name: 'Avocolada Smoothie', category: 'Smoothies' },
  { name: 'Cranberry Craze Smoothie', category: 'Smoothies' },
  { name: 'Peanut Paradise Smoothie', category: 'Smoothies' },
  { name: 'Caprese Flatbread', category: 'Flatbreads' },
  { name: 'Thai Chicken Flatbread', category: 'Flatbreads' },
  { name: 'Buffalo Chicken Flatbread', category: 'Flatbreads' },
  { name: 'Hummus Veggie Wrap', category: 'Wraps' },
  { name: 'Chicken Pesto Wrap', category: 'Wraps' },
  { name: 'Turkey & Bacon Ranch Wrap', category: 'Wraps' },
  { name: 'Acai Bowl', category: 'Bowls' },
];
class TropicalSmoothieCafe extends BaseScraper {
  constructor() { super({ chainName: 'TropicalSmoothieCafe', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async _parseBodyText() {
    ...
    const items = []; let cat = 'Smoothies'; const seen = new Set();
