...
const KNOWN_ITEMS = [
  ...
  { name: 'Pecan Waffle',                  category: 'Waffles' },
  { name: 'Blueberry Waffle',              category: 'Waffles' },
  { name: 'Chocolate Chip Waffle',         category: 'Waffles' },
  { name: 'Peanut Butter Waffle',          category: 'Waffles' },
  { name: 'Eggs (any style)',              category: 'Eggs' },
  { name: 'Cheese Eggs',                   category: 'Eggs' },
  { name: 'Hashbrowns',                    category: 'Hashbrowns' },
  { name: 'Scattered Hashbrowns',          category: 'Hashbrowns' },
  { name: 'Smothered Hashbrowns',          category: 'Hashbrowns' },
  { name: 'Covered Hashbrowns',            category: 'Hashbrowns' },
  { name: 'Country Hashbrowns',            category: 'Hashbrowns' },
  { name: 'Bacon',                         category: 'Meats' },
  { name: 'Sausage',                       category: 'Meats' },
  { name: 'Ham',                           category: 'Meats' },
  { name: 'T-Bone Steak',                  category: 'Meats' },
  { name: 'All-Star Special',              category: 'Plates' },
  { name: 'Triple Play',                   category: 'Plates' },
  { name: 'Two & Two',                     category: 'Plates' },
  { name: 'Grilled Chicken Sandwich',      category: 'Sandwiches' },
  { name: 'BLT',                           category: 'Sandwiches' },
  { name: 'Cheese Melt',                   category: 'Sandwiches' },
  { name: 'Toast',                         category: 'Sides' },
  { name: 'Grits',                         category: 'Sides' },
...
class WaffleHouse extends BaseScraper {
  ...
  async _parseBodyText() {
    ...
    const items = []; let cat = 'Waffles'; const seen = new Set();
