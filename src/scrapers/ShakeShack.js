...
const OFFICIAL_URL = 'https://www.shakeshack.com/nutrition/';
const ALT_URL = 'https://www.shakeshack.com/menu/';
...
class ShakeShack extends BaseScraper {
  constructor() { super({ chainName: 'ShakeShack', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async extractAllergens(item) {
    ...
    row.sourceText='Allergen data not accessible -- check https://www.shakeshack.com/nutrition/';
    return row;
  }
}
module.exports = ShakeShack;
