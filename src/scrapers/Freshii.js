...
const OFFICIAL_URL = 'https://www.freshii.com/nutrition';
const ALT_URL = 'https://www.freshii.com/menu';
...
const KNOWN_ITEMS = [
  { name: 'Teriyaki Chicken Bowl', category: 'Bowls' },
  { name: 'Bangkok Salad', category: 'Salads' },
  { name: 'Mexicali Burrito', category: 'Burritos' },
  { name: 'Pangoa Bowl', category: 'Bowls' },
  { name: 'Chickpea Bowl', category: 'Bowls' },
  { name: 'Spring Farro Bowl', category: 'Bowls' },
  { name: 'Tuna Quinoa Bowl', category: 'Bowls' },
  { name: 'Spicy Thai Wrap', category: 'Wraps' },
  { name: 'Avo White Bean Wrap', category: 'Wraps' },
  { name: 'Freshii Burrito', category: 'Burritos' },
  { name: 'Caesar Salad', category: 'Salads' },
  { name: 'Superfood Salad', category: 'Salads' },
  { name: 'Oatmeal', category: 'Breakfast' },
  { name: 'Mango Sunrise Smoothie', category: 'Smoothies' },
  { name: 'Green Smoothie', category: 'Smoothies' },
  { name: 'Protein Shake', category: 'Smoothies' },
];
class Freshii extends BaseScraper {
  constructor() { super({ chainName: 'Freshii', officialUrl: OFFICIAL_URL }); this._headers = null; }
