...
const OFFICIAL_URL = 'https://smashburger.com/menu/nutrition';
const ALT_URL = 'https://smashburger.com/nutrition';
...
const KNOWN_ITEMS = [
  { name: 'Classic Smash',                category: 'Burgers' },
  { name: 'Double Classic Smash',         category: 'Burgers' },
  { name: 'BBQ Bacon Smash',              category: 'Burgers' },
  { name: 'Avocado Club',                 category: 'Burgers' },
  { name: 'Spicy Jalapeno Baja Burger',   category: 'Burgers' },
  { name: 'Bacon Smash',                  category: 'Burgers' },
  { name: 'Mushroom Swiss Smash',         category: 'Burgers' },
  { name: 'Truffle Mushroom Swiss Smash', category: 'Burgers' },
  { name: 'Classic Smash Chicken',        category: 'Chicken' },
  { name: 'Crispy Buffalo Ranch Chicken', category: 'Chicken' },
  { name: 'Grilled Chicken Club',         category: 'Chicken' },
  { name: 'Smash Fries',                  category: 'Sides' },
  { name: 'Classic Smash Fries',          category: 'Sides' },
  { name: 'Sweet Potato Fries',           category: 'Sides' },
  { name: 'Veggie Frites',                category: 'Sides' },
...
class Smashburger extends BaseScraper {
  constructor() { super({ chainName: 'Smashburger', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async extractAllergens(item) {
    ...
    row.sourceText='Allergen data not accessible — check smashburger.com/menu/nutrition';
    return row;
  }
}
