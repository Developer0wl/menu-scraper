...
const OFFICIAL_URL = 'https://www.texasroadhouse.com/nutritional-information';
const ALT_URL = 'https://www.texasroadhouse.com/menu';
...
const KNOWN_ITEMS = [
  { name: 'Dallas Filet',                  category: 'Steaks' },
  { name: 'Ft. Worth Ribeye',              category: 'Steaks' },
  { name: 'NY Strip',                      category: 'Steaks' },
  { name: 'Bone-In Ribeye',                category: 'Steaks' },
  { name: 'Portobello Mushroom Chicken',   category: 'Chicken & Seafood' },
  { name: 'Herb Crusted Chicken',          category: 'Chicken & Seafood' },
  { name: 'Grilled BBQ Chicken',           category: 'Chicken & Seafood' },
  { name: 'Grilled Salmon',                category: 'Chicken & Seafood' },
  { name: 'Grilled Shrimp',                category: 'Chicken & Seafood' },
  { name: 'Country Fried Chicken',         category: 'Country Dinners' },
  { name: 'Country Fried Steak',           category: 'Country Dinners' },
  { name: 'Baby Back Ribs (Full Rack)',    category: 'Ribs' },
  { name: 'Baby Back Ribs (Half Rack)',    category: 'Ribs' },
  { name: 'St. Louis Ribs (Full Rack)',    category: 'Ribs' },
  { name: 'Chili',                         category: 'Starters & Sides' },
  { name: 'Caesar Salad',                  category: 'Salads' },
  { name: 'Grilled Chicken Salad',         category: 'Salads' },
  { name: 'House Salad',                   category: 'Salads' },
  { name: 'Fresh Baked Bread',             category: 'Sides' },
  { name: 'Mashed Potatoes',               category: 'Sides' },
  { name: 'Sweet Potato',                  category: 'Sides' },
  { name: 'Seasoned Rice',                 category: 'Sides' },
  { name: 'Green Beans',                   category: 'Sides' },
  { name: 'Corn',                          category: 'Sides' },
  { name: 'Steak Fries',                   category: 'Sides' },
];

class TexasRoadhouse extends BaseScraper {
  constructor() { super({ chainName: 'TexasRoadhouse', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async extractAllergens(item) {
    ...
    row.sourceText='Allergen data not accessible — check texasroadhouse.com/nutritional-information';
    return row;
  }
}
