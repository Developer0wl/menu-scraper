...
const OFFICIAL_URL = 'https://www.thecheesecakefactory.com/assets/pdf/Allergen_Chart.pdf';
const ALT_URL = 'https://www.thecheesecakefactory.com/menu/';
...
const KNOWN_ITEMS = [
  ...
  {
    "name": "Warm Crab and Artichoke Dip",
    "category": "Appetizers"
  },
  {
...
class CheesecakeFactory extends BaseScraper {
  constructor() { super({ chainName: 'CheesecakeFactory', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async extractAllergens(item) {
    ...
    row.sourceText='Allergen data not accessible -- check https://www.thecheesecakefactory.com/assets/pdf/Allergen_Chart.pdf';
    return row;
  }
}
module.exports = CheesecakeFactory;
