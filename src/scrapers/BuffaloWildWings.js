...
const OFFICIAL_URL = 'https://www.buffalowildwings.com/en/food/nutrition-and-allergen-info/';
const ALT_URL = 'https://www.buffalowildwings.com/en/food/';
...
const KNOWN_ITEMS = [
  { name: 'Traditional Wings', category: 'Wings' },
  { name: 'Boneless Wings', category: 'Wings' },
  { name: 'Cauliflower Wings', category: 'Wings' },
  { name: 'Buffalo Wings', category: 'Wings' },
  { name: 'Chicken Tenders', category: 'Tenders & Chicken' },
  { name: 'Crispy Chicken Sandwich', category: 'Burgers & Sandwiches' },
  { name: 'Classic Burger', category: 'Burgers & Sandwiches' },
  { name: 'Bacon Cheeseburger', category: 'Burgers & Sandwiches' },
  { name: 'Nachos', category: 'Appetizers' },
  { name: 'Mozzarella Sticks', category: 'Appetizers' },
  { name: 'Fried Pickles', category: 'Appetizers' },
  { name: 'Buffalo Cauliflower', category: 'Appetizers' },
  { name: 'Garden Salad', category: 'Salads' },
  { name: 'House Salad', category: 'Salads' },
  { name: 'Street Tacos', category: 'Tacos' },
  { name: 'French Fries', category: 'Sides' },
  { name: 'Onion Rings', category: 'Sides' },
  { name: 'Coleslaw', category: 'Sides' },
  { name: 'Celery', category: 'Sides' },
  { name: 'Carrot Sticks', category: 'Sides' },
  { name: 'Mac and Cheese', category: 'Sides' },
  { name: 'Chocolate Lava Cake', category: 'Desserts' },
];

class BuffaloWildWings extends BaseScraper {
  constructor() { super({ chainName: 'BuffaloWildWings', officialUrl: OFFICIAL_URL }); this._headers = null; }
  ...
  async _parseBodyText() {
    ...
    const items = []; let cat = 'Wings'; const seen = new Set();
  ...
  async extractAllergens(item) {
    ...
    row.sourceText='Allergen data not accessible — check buffalowildwings.com nutrition page';
    return row;
  }
}
module.exports = BuffaloWildWings;
